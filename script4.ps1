...
foreach ($repertoires in $ListeRepertoire)
      {
        ...
        Start-Process -FilePath "c:\windows\system32\robocopy.exe" -ArgumentList "c:\users\$nomuser\Documents \\SRVACME\sav$\$nompc\$nomuser\Documents /copy:DAT /E /TS /FP /V /LOG+:\\SRVACME\sav$\$nompc.log /TEE " 
